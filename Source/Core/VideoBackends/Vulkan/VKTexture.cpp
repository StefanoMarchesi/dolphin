                                   ...
                                   ComputeImageLayout new_layout) const
{
  ...
  g_command_buffer_mgr->NotifyPipelineBarrier(V3DBarrierType::ComputeLayout);
...
void VKTexture::PrepareForRenderPass(VkCommandBuffer command_buffer) const
{
  ...
  if (m_written_since_last_layout_change)
  {
    ...
    g_command_buffer_mgr->NotifyPipelineBarrier(V3DBarrierType::AttachmentHazard);
                                                    ...
                                                    const MathUtil::Rectangle<int>& dst_rect)
{
  ...
  g_command_buffer_mgr->NotifyPipelineBarrier(V3DBarrierType::StagingImage);
